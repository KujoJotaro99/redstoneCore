...
#(
    ...
    input logic [0:0] if_id_instr_access_fault_i,
    ...
    output logic [WIDTH_P-1:0] id_ex_instr_o,
    ...
    output logic [0:0] id_ex_instr_access_fault_o,
    ...
    logic [0:0] id_ex_rs1_used_q;
    logic [0:0] id_ex_rs2_used_q;
    logic [$clog2(DEPTH_P)-1:0] id_ex_rs1_addr_q;
    logic [$clog2(DEPTH_P)-1:0] id_ex_rs2_addr_q;
    logic [0:0] pending_load_valid_q;
    logic [$clog2(DEPTH_P)-1:0] pending_load_rd_addr_q;
    ...
    u_hazard_unit (
        ...
        .rs1_addr_i(id_ex_rs1_addr_w),
        .rs2_addr_i(id_ex_rs2_addr_w),
        .id_ex_rs1_used_i(id_ex_rs1_used_q),
        .id_ex_rs2_used_i(id_ex_rs2_used_q),
        ...
        .pending_load_valid_i(pending_load_valid_q),
        .pending_load_rd_addr_i(pending_load_rd_addr_q),
    ...
    always_ff @(posedge clk_i) begin
        if (!rstn_i) begin
            ...
            id_ex_rs2_addr_q <= '0;
            id_ex_rd_addr_o <= '0;
            id_ex_rs1_used_q <= 1'b0;
            id_ex_rs2_used_q <= 1'b0;
            id_ex_alu_op_o <= '0;
            ...
            id_ex_instr_access_fault_o <= 1'b0;
            ...
            id_ex_imm_o <= id_ex_imm_w;
            id_ex_rs1_addr_q <= id_ex_rs1_addr_w;
            id_ex_rs2_addr_q <= id_ex_rs2_addr_w;
            id_ex_rd_addr_o <= id_ex_rd_addr_w;
            id_ex_rs1_used_q <= id_ex_rs1_used_w;
            id_ex_rs2_used_q <= id_ex_rs2_used_w;
            id_ex_alu_op_o <= id_ex_alu_op_w;
            id_ex_alu_src_a_sel_o <= id_ex_alu_src_a_sel_w;
            id_ex_alu_src_b_sel_o <= id_ex_alu_src_b_sel_w;
            ...
            id_ex_instr_illegal_o <= id_ex_instr_illegal_w;
            id_ex_instr_access_fault_o <= if_id_instr_access_fault_i;
            id_ex_reg_write_o <= id_ex_reg_write_w;
            id_ex_mem_read_o <= id_ex_mem_read_w;
            id_ex_mem_write_o <= id_ex_mem_write_w;
            id_ex_funct3_o <= id_ex_funct3_w;
        ...
        // fixes issue with loop and compare tests. 
        if (rstn_i && !flush_i) begin
            // set pending load.
            if (id_if_ready_o && if_id_valid_i && id_ex_mem_read_w && id_ex_reg_write_w && id_ex_rd_addr_w != '0) begin
                pending_load_valid_q <= 1'b1;
                pending_load_rd_addr_q <= id_ex_rd_addr_w;
            end
